...
const getNamedCurve1 = (keyData)=>{
    ...
    switch(true){
        ...
        case keyDataStr.includes(new Uint8Array([
            ...
            return 'P-521';
        case (isCloudflareWorkers() || isNodeJs()) && keyDataStr.includes(new Uint8Array([
            6,
            3,
            43,
            101,
            ...
            return 'Ed25519';
        case isNodeJs() && keyDataStr.includes(new Uint8Array([
            6,
            3,
            43,
            101,
...
async function importKeys(alg, publicKey, privateKey) {
    return [
        alg,
        await importSPKI(publicKey, alg),
